...
export default function TalleresView({ type, lotes, pagos = [], addTaller, deleteTaller, updateTaller, addPago, deletePago, updatePago, isAdmin, formatCurrency, exportToCSV, searchQuery, dateFilter }) {
  ...
  return (
    <div className="fade-in">
      ...
      <div className="stats-grid" style={{ marginBottom: '12px' }}>
        <div className="glass-panel stat-card"><span className="text-muted">Total Trabajo</span><span style={{ fontSize: '1.3rem', fontWeight: 700 }}>{formatCurrency(totalTrabajo)}</span></div>
